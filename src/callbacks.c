...
{
	const gchar *authors[] = { 
		"Germán Poo Caamaño <gpoo@mate.org>", 
	...
	gtk_show_about_dialog (parent,
			       ...
			       "program-name", _("MATE Network Tools"),
			       "name", _("MATE Network Tools"),
			       "authors", authors,
...
on_help_activate (gpointer window, GtkWidget *menu_item)
{
	...
	gtk_show_uri (screen, "ghelp:mate-nettool",
